 ...
 * $Id: DBLoopOver.java,v 1.1.2.11 2006/07/17 16:10:54 mike Exp $
 */
...
public class DBLoopOver extends DBAction {
	...
	public zXType.rc go(DocBuilder pobjDocBuilder) throws ZXException {
        ...
        try {
        	...
        	while (!objRS.eof()) {
        		/**
        		 * Load entity collection again to make sure that we never
        		 * get confused when entities with the same name are used
        		 * in actions called in the loop
        		 */
            	...
            	/**
            	 * And loop-the-loop if row is active
            	 */
