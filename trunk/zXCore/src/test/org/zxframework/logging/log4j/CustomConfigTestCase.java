...
public class CustomConfigTestCase extends DefaultConfigTestCase {
     ...
     */
    protected String testMessages[] = { "info", "warn", "error", "fatal" };
    ...
    public void setUp() throws Exception {
        setUpAppender("org/zxframework/logging/log4j/CustomConfig.properties");
     ...
     * @throws Exception Thrown if testExceptionMessages fails.
     */
     ...
     * @throws Exception Thrown if testPlainMessages fails.
     */
     ...
     * @throws Exception Thrown if testSerializable fails.
     */
        ...
        for (int i = 0; i < testMessages.length; i++) {
            ...
            */
            if (thrown) {
                ...
                assertNull("LoggingEvent thrown", event.getThrowableInformation());
            }
        }
     ...
     * 
     * @param config
     * @throws Exception Thrown if setUpAppender fails.
     */
     ...
     * 
     * @param name Name of custom logger.
     * @throws Exception Thrown if setUpLogger fails.
     */
